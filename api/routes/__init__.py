...
from .tools_parameters import tools_parameters_bp
from .tools_forensics import tools_forensics_bp
from .tools_web_frameworks import tools_web_frameworks_bp
from .tools_recon import tools_recon_bp
...
__all__ = [
    ...
    'tools_cloud_bp', 'tools_web_bp', 'tools_web_advanced_bp',
    'tools_network_bp', 'tools_exploit_bp', 'tools_binary_bp',
    'tools_api_bp', 'tools_parameters_bp', 'tools_forensics_bp',
    'tools_web_frameworks_bp', 'tools_recon_bp'
]
