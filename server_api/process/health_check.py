"""
Process management system health check API endpoint.
"""
...
api_process_health_check_bp = Blueprint("api_process_health_check", __name__)

enhanced_process_manager = EnhancedProcessManager()


@api_process_health_check_bp.route("/api/process/health-check", methods=["GET"])
