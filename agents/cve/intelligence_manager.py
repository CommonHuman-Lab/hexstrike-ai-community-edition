...
# Import ModernVisualEngine from core module
        ...
        severity_color = (
            ...
            if severity == "critical"
                ...
                if severity == "high"
                    ...
                    ModernVisualEngine.COLORS["CYBER_ORANGE"]
                    if severity == "medium"
                    else (
                        ModernVisualEngine.COLORS["CYBER_ORANGE"]
                        if severity == "low"
...
"""
        ...
        for pid, proc_info in processes.items():
            ...
            mini_bar = ModernVisualEngine.render_progress_bar(progress, width=20, style="cyber", eta=eta)
