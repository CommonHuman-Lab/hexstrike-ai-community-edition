...
Implements checkpoint/resume pattern from skills/autonomous-mode/autonomous-agent-patterns
(Section 5.2: CheckpointManager) and durable execution from skills/workflow-automation.
